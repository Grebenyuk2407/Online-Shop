...
import dev.androidbroadcast.onlineshop.databinding.ViewholdereColorBinding
...
class ColorAdapter(val items:MutableList<String>):
    ...
    class Viewholder(val binding: ViewholdereColorBinding):
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ColorAdapter.Viewholder {
        ...
        val binding = ViewholdereColorBinding.inflate(LayoutInflater.from(context),parent,false)
